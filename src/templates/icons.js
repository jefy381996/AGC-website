...
const icons = {
  ...
  tiktok: `<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <path d="M16.58 5.79a4.79 4.79 0 0 1-1.12-2.79h-3.2v12.6a2.46 2.46 0 0 1-2.46 2.4 2.5 2.5 0 0 1-2.5-2.5 2.47 2.47 0 0 1 3.2-2.36V9.9a5.7 5.7 0 0 0-.7-.05 5.66 5.66 0 1 0 5.66 5.66V9.16a7.9 7.9 0 0 0 4.3 1.29V7.29a4.72 4.72 0 0 1-3.18-1.5Z"/>
  </svg>`,

  instagram: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" aria-hidden="true">
    <rect x="3" y="3" width="18" height="18" rx="5"/>
    <circle cx="12" cy="12" r="3.8"/>
    <circle cx="17.3" cy="6.7" r="1.1" fill="currentColor" stroke="none"/>
  </svg>`,

  snapchat: `<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <path d="M12 2.2c2.6 0 4.3 2 4.3 4.5 0 .8-.06 1.5-.1 2 .2.1.5.15.8.1.5-.1.9-.4 1.2-.4.4 0 .8.3.8.7 0 .5-.6.8-1.2 1-.5.2-1 .4-1 .8 0 .2.1.4.2.7.6 1.4 1.8 2.6 3 2.9.3.1.5.3.5.6 0 .6-1.2 1-2.2 1.1-.2 0-.3.2-.4.5l-.1.5c-.1.3-.3.4-.6.4-.4 0-.9-.15-1.6-.15-1.1 0-1.7.2-2.4.8-.7.6-1.3 1-2.2 1s-1.5-.4-2.2-1c-.7-.6-1.3-.8-2.4-.8-.7 0-1.2.15-1.6.15-.3 0-.5-.1-.6-.4l-.1-.5c-.1-.3-.2-.5-.4-.5-1-.1-2.2-.5-2.2-1.1 0-.3.2-.5.5-.6 1.2-.3 2.4-1.5 3-2.9.1-.3.2-.5.2-.7 0-.4-.5-.6-1-.8-.6-.2-1.2-.5-1.2-1 0-.4.4-.7.8-.7.3 0 .7.3 1.2.4.3.05.6 0 .8-.1-.04-.5-.1-1.2-.1-2 0-2.5 1.7-4.5 4.3-4.5Z"/>
  </svg>`,
